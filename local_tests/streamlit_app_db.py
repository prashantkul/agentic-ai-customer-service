#!/usr/bin/env python3
"""
Streamlit app for the Database-backed Customer Service Agent.
...
# --- Page Configuration ---
st.set_page_config(
    page_title="Customer Service Chat (DB)",
    page_icon="🛒",
    layout="wide"
)
...
with st.container():
    ...
    with col2:
        st.title("Customer Service Chat (Database Version)")
        st.caption("Welcome to BetterSale's Customer Service Chat with SQLite Database")
    st.divider()
